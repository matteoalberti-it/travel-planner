  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <h1 className="text-2xl font-bold mb-2 text-center">Crea il tuo account</h1>
        <p className="text-white/50 text-sm text-center mb-8">Inizia a pianificare il tuo primo viaggio</p>
